...
| `3.0.2` | `>=3.0.0 <4.0.0` | `>=3.0.0 <4.0.0` | `>=3.0.0 <4.0.0` | `>=3.0.0 <4.0.0` (pin: `null` — first release pending) | dropped (legacy MCP fully removed) |
| `3.0.3` | `>=3.0.0 <4.0.0` | `>=3.0.0 <4.0.0` | `>=3.0.0 <4.0.0` | `>=3.0.0 <4.0.0` (pin: `null` — first release pending) | dropped (legacy MCP fully removed) |
